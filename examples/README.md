...
| [`untrusted-comment.sample.diff`](untrusted-comment.sample.diff) → [`untrusted-comment.sample-report.md`](untrusted-comment.sample-report.md) | [`untrusted-diff`](../guardrails/untrusted-diff.md) | instruction-shaped comment is a finding; comment-only XSS/IDOR claims are withheld |
